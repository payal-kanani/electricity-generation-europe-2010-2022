...
* **Trend over Time:**
    * **Line Chart:** This page features a line chart showing the total electricity generated over time, broken down by electricity generation source.
    * **Slicre:** Users can interactively filter the data using slicers for Year, Energy type and Country.
